angular.module("auth", ['ngCookies']).factory("authService", function($q, $location, $cookieStore) {
...
chimera.system.main.controller("AuthController", function($scope, $q, authService) {

    authService.initialize();

    // Запись в скоп всех данных
    if (authService.isReady()) {
        authService.me().done(function(data) {
            $scope.user = data;
            console.log(data);
